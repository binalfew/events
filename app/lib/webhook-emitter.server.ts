...
/**
 * Feature-flag-gated entry point for emitting webhook events.
 * All services should use this function instead of calling the dispatcher directly.
 * Errors are caught and logged — webhook failures never propagate.
 */
