            ...
            <div key={event.id} className="rounded-lg border bg-card p-6 shadow-sm">
              ...
              <div className="mt-4 space-y-2 text-sm">
                ...
                <div className="flex flex-wrap gap-x-3 gap-y-1">
                  ...
                  <Link
                    to={`/admin/events/${event.id}/waitlist`}
                    className="text-primary hover:underline"
                  >
                    Waitlist
                  </Link>
                  ...
                  <Link
                    to={`/admin/events/${event.id}/catering`}
                    className="text-primary hover:underline"
                  >
                    Catering
                  </Link>
                  <Link
                    to={`/admin/events/${event.id}/parking`}
                    className="text-primary hover:underline"
                  >
                    Parking
                  </Link>
                  ...
                  <Link
                    to={`/admin/events/${event.id}/staff`}
                    className="text-primary hover:underline"
                  >
                    Staff
                  </Link>
                ...
                <div className="flex flex-wrap gap-x-3 gap-y-1">
                  ...
                  <Link
                    to={`/admin/events/${event.id}/companions`}
                    className="text-primary hover:underline"
                  >
                    Companions
                  </Link>
                ...
                <div className="flex flex-wrap gap-x-3 gap-y-1">
                  ...
                  <Link
                    to={`/admin/events/${event.id}/surveys`}
                    className="text-primary hover:underline"
                  >
                    Surveys
                  </Link>
                ...
                <div className="flex flex-wrap gap-x-3 gap-y-1">
                  ...
                  <Link
                    to={`/admin/events/${event.id}/compliance`}
                    className="text-primary hover:underline"
                  >
                    Compliance
                  </Link>
