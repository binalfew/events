...
const API_PERMISSIONS = [
  ...
  { value: "events:create", label: "Events: Create" },
  { value: "events:update", label: "Events: Update" },
  { value: "events:delete", label: "Events: Delete" },
  { value: "events:*", label: "Events: All" },
  { value: "participants:read", label: "Participants: Read" },
  { value: "participants:create", label: "Participants: Create" },
  { value: "participants:update", label: "Participants: Update" },
  { value: "participants:*", label: "Participants: All" },
  { value: "workflows:read", label: "Workflows: Read" },
  { value: "workflows:*", label: "Workflows: All" },
];
...
export async function loader({ request }: Route.LoaderArgs) {
  const { user, roles } = await requirePermission(request, "api-keys", "manage");
...
export async function action({ request }: Route.ActionArgs) {
  const { user } = await requirePermission(request, "api-keys", "manage");
