...
| **UI Components**  | React 18, Radix UI, Tailwind CSS   | React 18.x, Radix latest, TW 3.x | Accessible primitives (WCAG 2.1 AA), utility-first styling, design token consistency                             | shadcn/ui (Radix-based anyway), Chakra UI (heavier runtime)                     |
