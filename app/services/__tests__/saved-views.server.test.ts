...
describe("saved-views.server", () => {
  ...
  describe("createView", () => {
    it("creates a view with defaults", async () => {
      const { createView } = await import("../saved-views.server");
    ...
    it("creates a kanban view with filters", async () => {
      const { createView } = await import("../saved-views.server");
  ...
  describe("listViews", () => {
    it("returns personal and shared views", async () => {
      const { listViews } = await import("../saved-views.server");
  ...
  describe("getDefaultView", () => {
    it("returns the default view", async () => {
      const { getDefaultView } = await import("../saved-views.server");
